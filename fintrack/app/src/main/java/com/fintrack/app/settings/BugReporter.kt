...
import com.fintrack.app.util.collectEnvInfo
import com.fintrack.app.util.openInBrowser
import com.fintrack.app.util.sendEmail
            ...
            Row(
                ...
                Button(
                    ...
                    onClick = {
                        openInBrowser(
                            context,
                            "https://github.com/fintrack/fintrack/issues",
                        )
                        onClose()
                    },
                )

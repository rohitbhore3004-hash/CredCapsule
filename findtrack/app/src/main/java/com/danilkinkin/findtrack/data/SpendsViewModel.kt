package com.danilkinkin.findtrack.data
...
import com.danilkinkin.findtrack.di.SpendsRepository
import com.danilkinkin.findtrack.util.countDaysToToday
import com.danilkinkin.findtrack.util.isToday
...
class SpendsViewModel @Inject constructor(
    ...
    private fun runChangeDayAction() {
        viewModelScope.launch {
            ...
            // Bug fix https://github.com/danilkinkin/findtrack/issues/28
            if (dailyBudget - spentFromDailyBudget > BigDecimal.ZERO) {

package com.findtrack.app.data
...
import com.findtrack.app.di.SpendsRepository
import com.findtrack.app.util.countDaysToToday
import com.findtrack.app.util.isToday
...
class SpendsViewModel @Inject constructor(
    ...
    private fun runChangeDayAction() {
        viewModelScope.launch {
            ...
            // Bug fix https://github.com/findtrack/findtrack/issues/28
            if (dailyBudget - spentFromDailyBudget > BigDecimal.ZERO) {

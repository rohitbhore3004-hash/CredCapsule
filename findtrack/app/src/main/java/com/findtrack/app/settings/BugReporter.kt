package com.findtrack.app.settings
...
import com.findtrack.app.util.collectEnvInfo
import com.findtrack.app.util.openInBrowser
import com.findtrack.app.util.sendEmail
            ...
            Row(
                ...
                Button(
                    ...
                    onClick = {
                        openInBrowser(
                            context,
                            "https://github.com/findtrack/findtrack/issues",
                        )
                        onClose()
                    },
                )
                ...
                Button(
                    ...
                    onClick = {
                        sendEmail(
                            context,
                            arrayOf("hello@findtrack.app"),
                            "FindTrack bug report",
                            """

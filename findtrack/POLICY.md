# Privacy Policy for FindTrack

At FindTrack, one of my main priorities is the privacy of users. 
This Privacy Policy document contains types of information that is collected and recorded by FindTrack app and how we use it.

If you have additional questions or require more information about my Privacy Policy, do not hesitate to contact with me.

This Privacy Policy applies only to my app and is valid for users to my app with regards to the information that they shared and/or collect in FindTrack. 
...
FindTrack follows a standard procedure of using log files. These files log some errors when app crashes.
